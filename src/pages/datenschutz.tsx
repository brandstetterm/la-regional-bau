...
export default () => (
	<Layout>
		<h1 className="text-xl text-secondary mb-4">Datenschutz&shy;erkl&auml;rung</h1>
		...
		<p>
			Diese Seite nutzt zur Bereitstellung und dem Betrieb Firebase Hosting, einen Dienst von Google. Beim Aufruf
			einer Seite lädt Ihr Browser die benötigten Daten, wie die HTML Datei, Stylesheets zur Darstellung,
			JavaScript für die Darstellung von Elemente und Bilder und zeigt diese an.
		</p>
		<p>
			Zu diesem Zweck muss der von Ihnen verwendete Browser Verbindung zu den Servern von Firebase Hosting
			aufnehmen. Hierdurch erlangt Google Kenntnis darüber, dass über Ihre IP-Adresse unsere Website aufgerufen
			wurde. Um einen sicheren Betrieb dieser Website gewährleisten zeichnet Google Ihre IP Adresse für einen von
			Google definierten Zeitraum auf. Die Aufzeichnung erfolgt Stand 01.04.2019 in den Vereinigten Staaten von
			Amerika. Die Speicherung erfolgt zur Sicherstellung des Betriebs und zur Abwehr von Gefahren für diese
			Website. Dies stellt ein berechtigtes Interesse im Sinne von Art. 6 Abs. 1 lit. f DSGVO dar. Weitere
			Informationen finden Sie unter{' '}
			<a href="https://firebase.google.com/support/privacy/">https://firebase.google.com/support/privacy/</a>.
		</p>
		<p>
			Das EU-U.S. und Swiss-U.S. Privacy Shield Framework wurde gemeinsam von U.S. Department of Commerce, der EU
			Kommission und der Schweizer Regierung entwickelt, um Unternehmen die in den jeweiligen Wirtschaftsräumen
			Dienste zur Verfügung stellen eine Rahmen zu geben, in dem die Datenschutzanforderung beim Transfer von
			personenbezogenen Daten, wie der IP-Adresse beim Hosting dieser Website, den Datenschutzanforderung der EU,
			der Schweiz und den Vereinigten Staaten entsprechen. Google ist zeritifiziertes Mitglied dieses Programms.
			Weitere Informationen zu diesem Programm finden Sie unter{' '}
			<a href="https://www.privacyshield.gov/Program-Overview">https://www.privacyshield.gov/Program-Overview</a>.
		...
		<p>
			&#91;Voller Namen bzw. die vollst&auml;ndige Unternehmensbezeichnung des Website-Betreibers sowie die
			vollst&auml;ndige Anschrift&#93;
		</p>
		<p>
		...
		<p className="text-secondary">
			Hosting Zu diesem Zweck muss der von Ihnen verwendete Browser Verbindung zu den Servern von Firebase Hosting
			aufnehmen. Hierdurch erlangt Google Kenntnis darüber, dass über Ihre IP-Adresse unsere Website aufgerufen
			wurde. Um einen sicheren Betrieb dieser Website gewährleisten zeichnet Google Ihre IP Adresse für einen von
			Google definierten Zeitraum auf. Die Aufzeichnung erfolgt Stand 01.04.2019 in den Vereinigten Staaten von
			Amerika. Die Speicherung erfolgt zur Sicherstellung des Betriebs und zur Abwehr von Gefahren für diese
			Website. Dies stellt ein berechtigtes Interesse im Sinne von Art. 6 Abs. 1 lit. f DSGVO dar. Weitere
			Informationen finden Sie unter https://firebase.google.com/support/privacy/. Das EU-U.S. und Swiss-U.S.
			Privacy Shield Framework wurde gemeinsam von U.S. Department of Commerce, der EU Kommission und der
			Schweizer Regierung entwickelt, um Unternehmen die in den jeweiligen Wirtschaftsräumen Dienste zur Verfügung
			stellen eine Rahmen zu geben, in dem die Datenschutzanforderung beim Transfer von personenbezogenen Daten,
			wie der IP-Adresse beim Hosting dieser Website, den Datenschutzanforderung der EU, der Schweiz und den
			Vereinigten Staaten entsprechen. Google ist zeritifiziertes Mitglied dieses Programms. Weitere Informationen
			zu diesem Programm finden Sie unter https://www.privacyshield.gov/Program-Overview. Weitere Anforderungen
			zur Zertifizierung von Google finden Sie unter
			https://www.privacyshield.gov/participant?id=a2zt000000001L5AAI&status=Active.
		</p>
	</Layout>
);
