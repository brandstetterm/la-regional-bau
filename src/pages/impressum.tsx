...
export default () => (
	<Layout>
		<h1 className="text-xl text-secondary mb-4">Impressum</h1>
		<p className="text-secondary">
			<b>"LA regional Bau" e.K.</b>
			<br />
			<b>Inhaber:</b> Andreas Leyrer
			<br />
			Schloßberg 32
			<br />
			84184 Tiefenbach
			...
			<br />
			<br />
			<b>Umsatzsteuer-Identifikationsnummer gem. §27a:</b> ...
			<br />
			<b>Umsatzsteuergesetz:</b> ...
			<br />
			<br />
			<b>Wirtschaftsidentifikationsnummer gem. §139c:</b> ...
			<br />
			<b>Abgabenordnung:</b> ...
			<br />
			<br />
